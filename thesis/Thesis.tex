...
\input{tex/abstract}% title page, abstract
...
% \input{tex/notation}% symbol list, preface content
...
% \input{tex/sarkisov}
\input{tex/descend}
\input{tex/doublescaling}
\input{tex/finitemodel}
\input{tex/foliation}
\input{tex/result}
...
% \input{tex/acknowledgement}% other information
\end{document}
%---------------------------------------------------------------------------%
