...
在第三章第四节，本文给出三种方法的具体例子。

Sarkisov 纲领有许多应用，例如2阶Cremona群的经典结果。即每一个射影平面的双有理自同构都是由自同构和标准二次映射复合生成。 (见 \cite[Chapter 2]{ksc04} )。 Takahashi \cite{tak95} 对算术曲面建立了特殊的Sarkisov纲领，并得到了另一个经典代数结论的几何证明：每一个仿射平面的自同构都由仿射自同构和上三角变换复合。(见 \cite[Chpter 13]{mat02}, Chapter 13)。Lamy\cite{lam22}给出了更多其他应用。
